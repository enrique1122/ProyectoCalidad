...
<html>
    ...
    <body>
        ...
        <table class="table table-striped">
            ...
            <thead>
                <tr>
                    <td colspan="2" align="center"> <a href="agregarClientet.jsp">Agregar</a></td>
                    <td><a href="index.jsp">Salir</a></td
                </tr>
                <tr align="center">
                    <td>Id</td><td>Dni</td><td>Nombre</td><td>Apellido</td><td>Direccion</td><td>Telefono</td>
                </tr>
            </thead>
            <tbody>
                <%
                ...
                <tr align="center">
                    ...
                    <td> <a href="editarClientet.jsp?cod=<%=lista.get(i).getId_cliente()%>">Actualizar</a> </td>
                    <td> <a href="servletCliente?accion=eliminart&cod=<%=lista.get(i).getId_cliente()%>">Eliminar</a> </td>
                </tr>
                <%}
                %>
            </tbody>
        ...
        <form>
            ...
            <p align="center"> <input  type="text" placeholder="Ingrese dni" name="buscado" required="" onkeypress="return numeros(event)" maxlength="8"> <input type="submit" name="Buscar" value="Buscar" class="btn btn-primary"> </p>
