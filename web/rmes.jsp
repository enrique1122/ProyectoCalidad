...
<html>
    ...
    <body>
        ...
        <form action="servletReporte" class="enviar">
            ...
            <input type="submit" name="accion" value="EnviarMes" class="btn btn-primary">
        </form>
        <form class="f1">
                ...
                <table class="table table-striped">
                    ...
                    <tbody></tbody>
                        ...
                        <p align="center"><input type="submit" name="accion" value="Ver Detalle De Factura Mes" class="btn btn-primary">                       
